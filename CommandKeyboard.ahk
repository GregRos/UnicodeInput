...
; 7th of May, 2017
; CommandKeyboard, written by Gregory Rosenbaum 
; ======================================================
...
#include Includes/
#include JSON.ahk ;JSON parser
;=============================================
; Rich tooltip libraries
;---------------------------------------------
#include sizeof.ahk ;Dependency of _Struct.ahk, TT.ahk
#include _Struct.ahk ;Dependency of TT.ahk
#include TT.ahk ;Tooltip library, 
#include AhkUtility.ahk
...
global arrKeyPrematureTerminators := [	"F1","F2","F3","F4","F5","F6","F7","F8","F9","F10","F11","F12"
	,"Up","Down","Left","Right","PgDn","PgUp","End","Home","Insert","Delete"
	,"Tab","!Tab","Escape","LWin","RWin","Enter"
	,"AppsKey", "LButton", "RButton"]
...
ExecuteCommand() 
{
	...
	totalLen := StrLen(strScriptMarker) + nodeNamespace.TotalLength
